...
import { ActiveTransferRestrictions, AddClaimCountStatParams, AddClaimCountTransferRestrictionParams, ClaimCountTransferRestriction, NoArgsProcedureMethod, ProcedureMethod, RemoveScopedCountParams, SetClaimCountTransferRestrictionsParams, TransferRestrictionType } from "../../../../../types";
/**
 * Handles all Claim Count Transfer Restriction related functionality
 */
export declare class ClaimCount extends TransferRestrictionBase<TransferRestrictionType.ClaimCount> {
    protected type: TransferRestrictionType.ClaimCount;
    /**
     ...
     */
    addRestriction: ProcedureMethod<Omit<AddClaimCountTransferRestrictionParams, 'type'>, BigNumber>;
    /**
     ...
     * @note the result is the total amount of restrictions after the procedure has run
     */
    setRestrictions: ProcedureMethod<Omit<SetClaimCountTransferRestrictionsParams, 'type'>, BigNumber>;
    /**
     ...
     */
    enableStat: ProcedureMethod<Omit<AddClaimCountStatParams, 'type'>, void>;
    /**
     ...
     */
    disableStat: ProcedureMethod<Omit<RemoveScopedCountParams, 'type'>, void>;
    /**
...
//# sourceMappingURL=ClaimCount.d.ts.map