...
import { Account, AuthorizationRequest, CheckpointSchedule, ChildIdentity, CorporateActionBase, CustomPermissionGroup, DefaultPortfolio, FungibleAsset, Identity, KnownPermissionGroup, MultiSig, NumberedPortfolio, Venue } from "../../internal";
import { ActiveTransferRestrictions, AddCountStatInput, AssetDocument, ClaimCountStatInput, ClaimCountTransferRestriction, ClaimPercentageTransferRestriction, ClaimTarget, CountTransferRestriction, InputCaCheckpoint, InputCondition, InputCorporateActionTargets, InputCorporateActionTaxWithholdings, InputStatClaim, InputStatType, InputTargets, InputTaxWithholding, InputTrustedClaimIssuer, KnownAssetType, KnownNftType, MetadataSpec, MetadataType, MetadataValueDetails, OfferingTier, PercentageTransferRestriction, PermissionedAccount, PermissionsLike, PortfolioLike, PortfolioMovement, Requirement, Scope, SecurityIdentifier, Signer, StatClaimIssuer, StatType, TransactionArray, TransactionPermissions, TxGroup, VenueType } from "../../types";
...
export declare type AddPercentageStatParams = {
    type: StatType.Balance;
};
export declare type AddClaimCountStatParams = ClaimCountStatInput & {
    type: StatType.ScopedCount;
};
export declare type AddClaimPercentageStatParams = StatClaimIssuer & {
 ...
 */
export declare type CollectionKeyInput = GlobalCollectionKeyInput | LocalCollectionKeyInput;
...
export declare type AddInstructionParams = {
    /**
...
export declare type AddInstructionWithVenueIdParams = AddInstructionParams & {
    venueId: BigNumber;
};
...
export declare type RejectInstructionParams = {
    /**
     * (optional) Portfolio that the signer controls and wants to reject the instruction
     */
    portfolio?: PortfolioLike;
};
export declare type AffirmOrWithdrawInstructionParams = {
    /**
...
export declare type ModifyInstructionAffirmationParams = InstructionIdParams & (({
    operation: InstructionAffirmationOperation.Affirm | InstructionAffirmationOperation.Withdraw;
} & AffirmOrWithdrawInstructionParams) | ({
    operation: InstructionAffirmationOperation.Reject;
} & RejectInstructionParams));
export declare type ExecuteManualInstructionParams = InstructionIdParams & {
    /**
...
export declare type NftMetadataInput = {
    type: MetadataType;
    id: BigNumber;
    value: string;
};
export declare type IssueNftParams = {
...
export declare type ModifyVenueParams = {
    description?: string;
    type: VenueType;
} | {
    description: string;
...
export declare type ModifyOfferingTimesParams = {
    /**
...
export declare type SetMetadataParams = {
    value: string;
    details?: MetadataValueDetails;
} | {
    details: MetadataValueDetails;
};
export declare type RegisterMetadataParams = {
    name: string;
    specs: MetadataSpec;
} | {
    name: string;
...
export declare type SetVenueFilteringParams = {
    enabled?: boolean;
