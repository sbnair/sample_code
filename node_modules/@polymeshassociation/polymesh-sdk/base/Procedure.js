...
function assertOnlyOneAsset(assets) {
    if (assets.length > 1) {
        throw new internal_1.PolymeshError({
            ...
            message: 'Procedures cannot require permissions for more than one Asset. Please contact the Polymesh team',
        });
    }
}
/**
    ...
    prepare(args, context, opts) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const mortality = (opts === null || opts === void 0 ? void 0 : opts.mortality) || {
                    immortal: false,
                };
                ...
                const spec = Object.assign(Object.assign({}, procedureResult), { signer,
                    signingAddress,
                    mortality,
                    transformer });
                if (!('transactions' in spec)) {
                    return new internal_1.PolymeshTransaction(spec, ctx);
                }
                else if (spec.transactions.length === 1) {
                    const [{ transaction, args: txArgs, fee, feeMultiplier }] = spec.transactions;
                    return new internal_1.PolymeshTransaction(Object.assign(Object.assign({}, spec), { transaction,
                        fee,
                        feeMultiplier, args: txArgs }), ctx);
                }
                else {
                    return new internal_1.PolymeshTransactionBatch(spec, ctx);
                }
            }
            finally {
                this.cleanup();
