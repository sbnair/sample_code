import { PolymeshPrimitivesAuthorization, PolymeshPrimitivesIdentityId } from "./types-lookup.ts";
...
import type { ApplyExtrinsicResult, ChainProperties, ChainType, DispatchResult, Health, NetworkState, NodeRole, PeerInfo, SyncState } from '@polkadot/types/interfaces/system';
import type { IExtrinsic, Observable } from '@polkadot/types/types';
import type { AssetDidResult, AuthorizationType, CanTransferGranularReturn, CappedFee, CddStatus, DidStatus, ExecuteInstructionInfo, IdentityClaim, IdentityId, InstructionId, KeyIdentityData, Member, NFTs, PipId, PortfolioId, ProtocolOp, RpcDidRecords, Signatory, Ticker, VoteCount } from "./polymesh";
...
declare module '@polkadot/rpc-core/types/jsonrpc' {
    interface RpcInterface {
        asset: {
             ...
             **/
            canTransferGranular: AugmentedRpc<(fromCustodian: Option<PolymeshPrimitivesIdentityId> | null | Uint8Array | PolymeshPrimitivesIdentityId, fromPortfolio: PortfolioId | {
                did?: any;
                kind?: any;
            } | string | Uint8Array, toCustodian: Option<PolymeshPrimitivesIdentityId> | null | Uint8Array | PolymeshPrimitivesIdentityId, toPortfolio: PortfolioId | {
                did?: any;
                kind?: any;
            } | string | Uint8Array, ticker: Ticker | string | Uint8Array, value: Balance | AnyNumber | Uint8Array, blockHash?: Hash | string | Uint8Array) => Observable<CanTransferGranularReturn>>;
        };
        author: {
            /**
        ...
        nft: {
             ...
             **/
            validateNFTTransfer: AugmentedRpc<(sender_portfolio: PortfolioId | {
                did?: any;
                kind?: any;
                ...
                ticker?: any;
                ids?: any;
            } | string | Uint8Array, blockHash?: Hash | string | Uint8Array) => Observable<DispatchResult>>;
        };
        offchain: {
            /**
        ...
        protocolFee: {
             ...
             **/
            computeFee: AugmentedRpc<(op: ProtocolOp | 'AssetRegisterTicker' | 'AssetIssue' | 'AssetAddDocuments' | 'AssetCreateAsset' | 'CheckpointCreateSchedule' | 'ComplianceManagerAddComplianceRequirement' | 'IdentityCddRegisterDid' | 'IdentityAddClaim' | 'IdentityAddSecondaryKeysWithAuthorization' | 'PipsPropose' | 'ContractsPutCode' | 'CorporateBallotAttachBallot' | 'CapitalDistributionDistribute' | number | Uint8Array, blockHash?: Hash | string | Uint8Array) => Observable<CappedFee>>;
        };
        rpc: {
            /**
        ...
        settlement: {
             ...
             **/
            getExecuteInstructionInfo: AugmentedRpc<(instructionId: InstructionId | AnyNumber | Uint8Array, blockHash?: Hash | string | Uint8Array) => Observable<ExecuteInstructionInfo>>;
        };
        staking: {
            /**
